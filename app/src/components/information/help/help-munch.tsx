...
export const HelpContent: React.FC = () => (
  <>
    ...
    <h5>What do I need to experience Gift?</h5>
    ...
    <p>No. You should feel free to use your phone speaker to listen to Gift while in the museum. Some wireless headphones are not supported.</p>
    ...
    <p>Visitors aged as young as 8 and over 75 can create gifts. Those aged 10 or under may need assistance from someone they’re with.</p>
    ...
    <h5>Can I make gifts when not at a museum?</h5>
    <p>No, the experience is designed for creating gifts at the museum only.</p>
    ...
    <h5>Do recipients need to come to the museum?</h5>
    <p>No, recipients are encouraged to open the gifts they receive at the museum, but you can open them anywhere if they choose to.</p>
    ...
    <p>Gift is planned to run at the Munch Museum until March 2020. Gifts created by visitors will only be accessible during this time. Gifts may also be deleted at the request of users (see below). Please read our terms and privacy for details of storing and deleting your data.</p>
    ...
    <p>Gifts contain audio messages that you will need to listen to when they open gifts. When creating gifts you need to record audio messages to accompany each object using your phone. Audio transcripts of the narrator’s audio are provided throughout the experience.</p>
    ...
    <h5>Why is Gift at the Munch Museum?</h5>
